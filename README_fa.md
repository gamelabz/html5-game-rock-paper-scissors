...
✊ Rock Paper Scissors — یک بازی HTML5 مدرن و بدون وابستگی، ساخته‌شده با Canvas و جاوااسکریپت خالص.

🎮 **بازی آنلاین:** https://gamelabz.github.io/html5-game-rock-paper-scissors/

## 📸 تصویر بازی

![Rock Paper Scissors](assets/images/screenshot.png)

## 🎯 درباره بازی

سنگ، کاغذ یا قیچی را انتخاب کن و در این رویارویی جاودانه از هوش مصنوعی پیشی بگیر.

## 🕹️ کنترل‌ها

- انتخاب: کلیک روی علامت
- بهترین از N: نمایش
- شروع دوباره: R

## ✨ ویژگی‌ها

- قوانین کلاسیک مقابل هوش مصنوعی
- شمارنده برد/باخت/مساوی
- نمایش انیمیشنی دست‌ها
